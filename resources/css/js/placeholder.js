    ...
    $.fn.placeholder_password_focus = function (caption) {
        if (!this.is(":password")) {
            if (this.val() == caption) {
                ...
                new_input.removeClass(
                    $.fn.placeholder_options.placeholded_class,
                );
    ...
    $.fn.placeholder = function (opts) {
        ...
        if ($.fn.placeholder_options.container) {
            $($.fn.placeholder_options.container_selector).each(function () {
                var caption = $(this)
                    .find($.fn.placeholder_options.caption_selector + ":first")
                    .html();
                var input = $(this).find(
                    "input:text:first, input:password:first, textarea:first",
                );
                if (caption && input[0]) {
        ...
        elements.each(function () {
            ...
            var caption =
                $.fn.placeholder_options.caption_prefix +
                input.attr("placeholder") +
                $.fn.placeholder_options.caption_postfix;
            ...
            pform
                .unbind("submit", $.fn.placeholder_clear)
                .bind("submit", $.fn.placeholder_clear);
