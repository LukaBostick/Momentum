...
let getYTPVideoID = function (e) {
    ...
    return (
        e.indexOf("youtu.be") > 0 || e.indexOf("youtube.com/embed") > 0
            ? (r = (t =
                  (r = e.substr(e.lastIndexOf("/") + 1, e.length)).indexOf(
                      "?list=",
                  ) > 0
...
!(function (jQuery, ytp) {
    (jQuery.mbYTPlayer = {
                    ...
                    (YTPlayer.inlinePlayButton = jQuery("<div/>")
                        ...
                        YTPlayer.inlinePlayButton.on("click", function (e) {
                            $YTPlayer.YTPPlay(),
                                ...
                                YTPlayer.opt.goFullScreenOnPlay &&
                        ...
                        (e.isBackground && ytp.backgroundIsInited) ||
                            ...
                            jQuery(e).on("YTPChanged", function (t) {
                                ...
                                let a = {
                                    ...
                                    playsinline:
                                        jQuery.mbBrowser.mobile && !e.isPlayer
                                            ? 1
                                            : 0,
                                ...
                                new YT.Player(e.playerID, {
                                    ...
                                    events: {
                                        ...
                                        onStateChange: function (r) {
                                            if (
                                                "function" !=
                                                typeof r.target.getPlayerState
                                            )
                                                return;
                                            let t,
                                        ...
                                        r.items[0]
                                            ? (!(function (r) {
                                                  (e.videoData = {}),
                                                      ...
                                                      (e.videoData.thumb_max = r
                                                          .thumbnails.maxres
                                                          ? r.thumbnails.maxres
                                                                .url
                                                          : null),
                                                      (e.videoData.thumb_high =
                                                          r.thumbnails.high
                                                              ? r.thumbnails
                                                                    .high.url
                                                              : null),
                                                      (e.videoData.thumb_medium =
                                                          r.thumbnails.medium
                                                              ? r.thumbnails
                                                                    .medium.url
                                                              : null),
        ...
        buildControls: function (YTPlayer) {
            ...
            vURL.indexOf("http") < 0 &&
                (vURL =
                    "https://www.youtube.com/watch?v=" + YTPlayer.opt.videoURL);
                ...
                if (
                    ...
                    if (
                        ...
                        jQuery.extend(d, e),
                            ...
                            (d[jQuery.CSS.sfx + "transition-duration"] =
                                r + "ms"),
                            (d[jQuery.CSS.sfx + "transition-delay"] = t + "ms"),
                            (d[jQuery.CSS.sfx + "transition-timing-function"] =
                                a),
                            setTimeout(function () {
                        ...
                        (t.y =
                            "object" == typeof r
                                ? r.clientY +
                                  ...
                                  this.offset().top
                                : "number" == typeof r
                                  ? ((t.opt.maxval - t.opt.initialval - r) *
                                        o) /
                                    t.opt.maxval
    ...
    (function (e) {
        (e.mbCookie = {
            ...
            get: function (e) {
                e += "=";
                for (
                    var r = document.cookie.split(";"), t = 0;
                    t < r.length;
                    t++
                ) {
